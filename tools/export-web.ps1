...
# repoint a build at another Supabase project without re-exporting.
...
Write-Host "Next: serve web/ and play it through before committing." -ForegroundColor Yellow
